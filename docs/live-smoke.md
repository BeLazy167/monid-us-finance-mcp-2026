...
The current evidence rows cost **$0.0063**. An earlier company-facts probe used runs `01M1N4K8A2W5418F5E0SYEGV36` and `01M1N4K89YPZVV0RW30WRZ9ZYZ`. It cost $0.0012 before the adjacency lock changed. Total live validation spend was **$0.0075**.

The smoke confirmed company catalog hydration, statement matrices, SEC filing URLs, OHLCV filtering, summary metrics, and entity-matched news. It did not test every ticker, exchange calendar, corporate currency, provider outage, or redistribution right.
