...
│   └── caching.mdx
├── mcp-tools/
│   └── overview.mdx           # generated from docs/fd-mcp-tool-schemas.json, see below
├── api-reference/
